...
TSDB_BENCHMARK_NUM_METRICS ?= 10000
...
bench: build
	...
	@$(TSDB_BIN) bench write --engine=$(ENGINE) --metrics=$(TSDB_BENCHMARK_NUM_METRICS) --out=$(TSDB_BENCHMARK_OUTPUT_DIR) $(TSDB_BENCHMARK_DATASET)
